Ext.define('Iphoenix.view.reportes.ventas.ReporteVentasPorProducto',{
	extend:'Ext.form.Panel',
	alias:'widget.ReporteVentasPorProducto',
	id:'ReporteVentasPorProducto',
	initComponent:function(){
		 function perc(v) {
		    ...
		    var bd = Ext.getBody(),
		        ...
		        selectItem = function(storeItem) {
		            var name = storeItem.get('codigointerno'),
		            ...
		            for (i = 0, items = series.items, l = items.length; i < l; i++) {
		                if (name == items[i].storeItem.get('codigointerno')) {
		...
		;
		    ...
		    var gridPanel = Ext.create('Ext.grid.Panel', {
		        ...
		        flex: 0.60,
		        store: 'reportes.VentasPorProductoStore',
	    ...
	    var gp = Ext.getCmp('VentasPorProducto');
	    Ext.apply(this,{
