...
class Iphoenix extends Db {
	...
	function getList(){
		$success=true;
		$count="Select count(*) as count from pedidos_facturas";
		$query="SELECT 
...
from pedidos_facturas a left join (pedidos_facturasestatus b) on 
(a.estatus=b.id) left join (vendedores_empresasfacturacion e) on 
(a.empresa=e.id)  WHERE ";
