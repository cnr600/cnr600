...
class Clientes extends Db {
	...
	function getList(){
		$success=true;
		$count="Select count(*) as count from vendedores_telefonos WHERE vendedor='".$_SESSION["vendedor"]."' AND ";
		 $query="SELECT
id,
telefono,
tipo,
...
vendedor
from vendedores_telefonos WHERE vendedor='".$_SESSION["vendedor"]."' AND";
...
function add(){
	 $query="INSERT INTO vendedores_telefonos
(
telefono,
tipo,
vendedor
...
function update(){
  ...
  $query="UPDATE vendedores_telefonos
SET
