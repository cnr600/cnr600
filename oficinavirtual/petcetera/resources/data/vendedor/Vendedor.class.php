...
class Clientes extends Db {
	...
	function getList(){
		$success=true;
		$count="Select count(*) as count from vendedores WHERE idvendedor='".$_SESSION["vendedor"]."' AND";
		 $query="SELECT
v.idvendedor,
titulo,
nombres as nombre,
...
amaterno,
genero as sexo,
DATE_FORMAT(fnacimiento, '%d-%m-%Y') as fechanac,
notas,
created,
...
latitud,
logitud as longitud
from vendedores v, vendedores_direcciones vd where v.idvendedor=vd.idvendedor AND  v.idvendedor='".$_SESSION["vendedor"]."' AND";
